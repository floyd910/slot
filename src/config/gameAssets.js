...
export const GAME4_VIEW2_INFO_BACKGROUND_SRC = "/assets/img/game4-view2-info-background-optimized.webp";
...
export const GAME2_COVER_SRC = "/assets/img/chooser/game2-background.avif";
...
export const GAME_AREA_BACKGROUND_SRC =
  "/assets/img/game-area-background-optimized.webp";
...
export const SHARED_FIRST_PAINT_ASSETS = [
  // Every visible element of the shared main game screen.
