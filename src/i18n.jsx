...
const copy = {
  ru: {
    ...
    operationPendingRecovery: "Результат предыдущей операции не подтверждён. Новые спины недоступны до подтверждения результата сервером.",
  ...
  tg: {
    ...
    loginRequired: "Лутфан, барои бозӣ ворид шавед.",
    ...
    operationPendingRecovery: "Натиҷаи амалиёти қаблӣ тасдиқ нашудааст. То тасдиқи натиҷа аз сервер спинҳои нав дастнорасанд.",
